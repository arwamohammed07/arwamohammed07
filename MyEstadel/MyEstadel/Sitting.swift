            ...
            List{
                Section{
                    ...
                    NavigationLink (destination: Privacy(), label: {
                            ...
                            SittingCell(title: "Privacy and Security", imgName: "shield.righthalf.filled", clr: Color("Green") , clor: .black)
                    ...
                    // MARK: -
                    NavigationLink (destination: Privacy(), label: {
                        SittingCell(title: "Contact us", imgName: "envelope", clr: Color("Green") , clor: .black)
                    })
                    // MARK: - Log Out
                    Button(action: {
                        // Showing Alert
